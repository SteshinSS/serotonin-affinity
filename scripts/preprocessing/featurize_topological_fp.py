...
log = logging.getLogger("Featurizer-TopologicalFP")


def get_parser():
    parser = argparse.ArgumentParser(description="Calculates topological fingerprints for train/val/test dataset.")
    parser.add_argument(
